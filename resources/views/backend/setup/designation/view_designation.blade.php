                    ...
                    <div class="col-8 mx-auto">
                        <div class="box">
                            <div class="box-header with-border d-flex justify-content-between align-items-center">
                                ...
                                <a href="{{ route('designation.add') }}" class="waves-effect waves-light btn-circle btn btn-success btn-sm">
                            ...
                            <div class="box-body">
                                <div class="table-responsive">
                                    <table id="example1" class="table table-bordered table-striped table-hover">
                                        ...
                                        <tbody>
                                            @foreach ($allData as $key => $designationData)
                                                <tr>
                                                    <td>{{ $key + 1 }}</td>
                                                    <td>{{ $designationData->name }}</td>
                                                    <td class="admin-table-btn-wrapper">
                                                        <a href="{{ route('designation.edit', $designationData->id) }}"
                                                            class="waves-effect waves-light btn btn-info btn-circle btn-sm">
                                                            <i class="mdi mdi-pencil font-size-16"></i>
                                                        </a>
                                                        <a href="{{ route('designation.delete', $designationData->id) }}"
