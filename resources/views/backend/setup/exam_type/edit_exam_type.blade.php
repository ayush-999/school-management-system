    ...
    <div class="content-wrapper">
        <div class="container-full">
            ...
            <section class="content">
                <a href="{{ route('exam.type.view') }}" class="waves-effect waves-light btn btn-outline btn-secondary btn-circle mt-2 btn-sm">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 col-12">
                                                    <div class="form-group mb-4">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" name="name" id="exam-type-name"
