                    ...
                    <div class="col-md-6 col-12 mx-auto mt-4">
                        <div class="box">
                            <div class="box-header with-border">
                                <h4 class="box-title">Add Fees Amount</h4>
                            </div>
                            <!-- /.box-header -->
                            <div class="box-body">
                                <div class="row">
                                    <div class="col">
                                        <form method="POST" action="{{ route('fees.amount.store') }}">
                                            @csrf
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="add_item">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4 col-12">
                                                                <div class="form-group mb-4">
                                                                    ...
                                                                    <div class="controls">
                                                                        <input type="text" name="amount[]" id="fees-amount"
                                                                            class="form-control" />
