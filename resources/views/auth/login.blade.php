                        ...
                        <div class="p-30 rounded30 box-shadowed b-2 b-dashed">
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <div class="checkbox text-white">
                                            <input type="checkbox" id="show_password" class="filled-in chk-col-success">
                                    ...
                                    <div class="col-6">
                                        <div class="fog-pwd text-right">
                                            ...
                                            <a href="#" class="text-white hover-info">
                            ...
                            <div class="text-center">
                                <p class="mt-15 mb-0 text-white">
                                    ...
                                    <a href="{{ route('register') }}" class="text-info ml-5">Sign Up
                                    </a>
                                </p>
                            </div>
                        </div>
