                    ...
                    <div class="col-xl-3 col-6">
                        <div class="box overflow-hidden pull-up">
                            <div class="box-body">
                                ...
                                <div>
                                    <p class="text-mute mt-20 mb-0 font-size-16">Present Students</p>
                                    <h3 class="text-white mb-0 font-weight-500">3200 <small class="text-danger"><i
                    ...
                    <div class="col-xl-3 col-6">
                        <div class="box overflow-hidden pull-up">
                            <div class="box-body">
                                ...
                                <div>
                                    <p class="text-mute mt-20 mb-0 font-size-16">Present Teachers</p>
                                    <h3 class="text-white mb-0 font-weight-500">3,200 <small class="text-success"><i
                                                class="fa fa-caret-up"></i> +2.5%</small></h3>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="box">
                            <div class="box-header">
                                <h4 class="box-title align-items-start flex-column">
                                    Recent Activities
                                    <small class="subtitle">What's happening recently</small>
                                </h4>
                            </div>
                            <div class="box-body">
